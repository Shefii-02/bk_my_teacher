    ...
    if (status == 'ongoing') {
      ...
      if (recorded != null && recorded.isNotEmpty) {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (_) =>
                VideoClassScreen(title: title, videoUrl: recorded, classId: c['id'], type: 'course',)
  ...
  Widget _buildAboutTab(Map<String, dynamic> info) {
    ...
    return ListView(
      ...
      children: [
        ...
        if (info['highlights'] is List &&
            (info['highlights'] as List).isNotEmpty) ...[
          const Text(
            'What you’ll learn',
