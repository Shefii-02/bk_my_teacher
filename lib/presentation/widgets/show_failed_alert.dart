...
class ShowFailedAlert extends StatefulWidget {
  final String title;
  ...
  @override
  State<ShowFailedAlert> createState() => _ShowFailedAlertState();
}

class _ShowFailedAlertState extends State<ShowFailedAlert>
        ...
        children: [
          ...
          ScaleTransition(
            ...
            child: Container(
              ...
              child: const Icon(Icons.info, color: Colors.white, size: 38),
            ),
          ),
