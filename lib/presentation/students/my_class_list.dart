...
import 'package:BookMyTeacher/presentation/components/demo_class_card.dart';
...
import '../components/demo_class_detail_bottom_sheet.dart';
...
class _MyClassListState extends State<MyClassList>
  ...
  Future<void> _fetchCourses() async {
    try {
      final result = await ApiService().fetchEnrolledCourses();
      setState(() {
                          ...
                          switch (category['category']) {
                            ...
                            case 'Demo Class':
                              return DemoClassCard(
                                course: item,
                                onTap: () => _showDemoClassDetail(item),
                                // onTap: () => context.push('/workshop-detail', extra: item['id'].toString()),
                              );
                            default:
  ...
  void _showDemoClassDetail(Map<String, dynamic> course) {
