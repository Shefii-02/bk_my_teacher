...
class StudentSchedulesSheet extends StatefulWidget {
  const StudentSchedulesSheet({super.key});

  @override
  State<StudentSchedulesSheet> createState() => _StudentSchedulesSheetState();
}

class _StudentSchedulesSheetState extends State<StudentSchedulesSheet> {
                      ...
                      onTap: () {
                        ...
                        if (event.type == "course") {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (_) =>
                                  StudentCourseDetailsPage(courseId: event.courseId!.toInt()),
                            ),
                          );
