...
class StudentWorkshopDetailsContent extends StatefulWidget {
  final WorkshopDetailsModel workshop;

  const StudentWorkshopDetailsContent({super.key, required this.workshop});

  @override
  State<StudentWorkshopDetailsContent> createState() => _StudentWorkshopDetailsContentState();
}

class _StudentWorkshopDetailsContentState extends State<StudentWorkshopDetailsContent>
