...
class StudentRatingsReviewsSheet extends ConsumerStatefulWidget {
  const StudentRatingsReviewsSheet({super.key});

  @override
  ConsumerState<StudentRatingsReviewsSheet> createState() =>
      _RatingsReviewsSheetState();
}

class _RatingsReviewsSheetState extends ConsumerState<StudentRatingsReviewsSheet> {
  int selectedIndex = 0;
