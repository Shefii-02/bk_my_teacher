...
class StudentWebinarDetailsContent extends StatefulWidget {
  ...
  const StudentWebinarDetailsContent({super.key, required this.course});

  @override
  State<StudentWebinarDetailsContent> createState() => _StudentWebinarDetailsContentState();
}

class _StudentWebinarDetailsContentState extends State<StudentWebinarDetailsContent>
