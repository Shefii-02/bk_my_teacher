...
class StudentOwnCoursesSheet extends StatefulWidget {
  const StudentOwnCoursesSheet({super.key});

  @override
  State<StudentOwnCoursesSheet> createState() => _StudentOwnCoursesSheetState();
}

class _StudentOwnCoursesSheetState extends State<StudentOwnCoursesSheet>
                            ...
                            child: GestureDetector(
                              onTap: () {
                                ...
                                if (course.type == "course") {
                                  page = StudentCourseDetailsPage(courseId: course.id);
