...
class SignUpTeacherLast extends StatefulWidget {
  const SignUpTeacherLast({super.key});

  @override
  State<SignUpTeacherLast> createState() => _SignUpTeacherLastState();
}

class _SignUpTeacherLastState extends State<SignUpTeacherLast> {
  int activeStep = 0;
