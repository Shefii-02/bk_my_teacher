...
// import 'package:BookMyTeacher/presentation/teachers/quick_action/task_listing_tab.dart';
...
//
//   const CourseDetailsContent({super.key, required this.course, this.onRefresh});
//
//   @override
...
//               _aboutTab(info),
//               _classesTab(),
//               // TaskListingTab(courseId: info.id),
...
//     final startedAt =  c.startedAt ?? '';
//     final endedAt =  c.endedAt ?? '';
//     final  careerGuidance  = c.careerGuidance ? Icons.check : Icons.close;
//     final  counsellingSection  = c.counsellingSection ? Icons.check : Icons.close;
//
//     return ListView(
//       padding: const EdgeInsets.all(16),
//       children: [
//         const SizedBox(height: 25),
//         Text('Instructor(s)', style: TextStyle(fontWeight: FontWeight.bold)),
//         SizedBox(height: 25),
//         //instructors list
//         Wrap(
//           spacing: 6,
//           runSpacing: 6,
//           children: (c.instructors ?? []).map((instructor) {
//             return _statChip(
...
//         SizedBox(height: 20),
//         //features
//         Text('Information`s', style: TextStyle(fontWeight: FontWeight.bold)),
//         SizedBox(height: 25),
//         Row(
...
//               label: duration.isEmpty ? '—' : duration,
//             ),
//             _statChip(
//               color: Color(0xFFE8F5E9),
//               icon: Icons.live_tv_outlined,
//               label: c.mode?.capitalize() ?? '',
//             ),
//             _statChip(
//               color: Color(0xFFE8F5E9),
//               icon: Icons.play_circle_outline_outlined,
//               label: c.typeClass?.capitalize() ?? '',
//             ),
//           ],
//         ),
//
...
//               color: Color(0xFFE8F5E9),
//               icon: Icons.grade,
//               label: c.level?.capitalize() ?? '',
//             ),
//             _statChip(
//               color: Color(0xFFE8F5E9),
//               icon: Icons.auto_graph_outlined,
//               label: c.courseType?.capitalize() ?? '',
//             ),
//             _statChip(
//               color: Color(0xFFE8F5E9),
//               icon: Icons.play_circle_outline_outlined,
...
//         SizedBox(height: 25),
//         //s features
//         Text('Special Features', style: TextStyle(fontWeight: FontWeight.bold)),
//         SizedBox(height: 25),
//         Row(
...
//       child: Column(
//         children: [
//           ScheduledClassSummaryRow(
//             total: _ongoingUpcoming.length + _completed.length,
//             done: _completed.length,
//             pending: _ongoingUpcoming.length,
//           ),
//           const TabBar(
//             labelColor: Colors.blue,
//             unselectedLabelColor: Colors.grey,
...
//         final c = classes[i];
//
//         // ✅ only show _ClassCard for completed, ListTile for ongoing/upcoming
//         if (isCompleted) {
//           return _ClassCard(
//             cls: c,
//             onAttendanceSaved: () => widget.onRefresh?.call(),
//             onDurationUpdated: () => widget.onRefresh?.call(),
//           );
//         }
//
//         // ongoing/upcoming — keep existing ListTile with edit/delete menu
//         final status = (c.classStatus ?? '').toLowerCase();
//         final id = c.id.toString();
//         final startTime = DateTime.tryParse(c.timeStart ?? '');
//         final endTime = DateTime.tryParse(c.timeEnd ?? '');
...
//     return _MaterialsList(materials: materials, onDownload: _downloadMaterial);
//   }
//
...
//       ScaffoldMessenger.of(
//         context,
//       ).showSnackBar(SnackBar(content: Text("Downloaded: $safeName.$ext")));
...
//
//   Widget _statChip({
//     Color color = const Color(0xFFE8F5E9), // default light green
...
// }
//
// class ScheduledClassSummaryRow extends StatelessWidget {
//   final int total, done, pending;
//   const ScheduledClassSummaryRow({
//     required this.total,
//     required this.done,
...
//       child: Row(
//         children: [
//           _StatBox(value: total, label: 'Total Scheduled', color: null),
//           const SizedBox(width: 8),
//           _StatBox(
//             value: done,
//             label: 'Completed',
...
//
//   const _MaterialsList({required this.materials, required this.onDownload});
//
//   @override
...
//     try {
//       final response = await TeacherApiService().deleteCourseMaterial(
...
// //   final CompletedClass _completed;
// //   final VoidCallback onAttendanceSaved;
// //   final VoidCallback onDurationUpdated;
// //
// //   const _ClassCard({
// //     required this.cls,
// //     required this.onAttendanceSaved,
// //     required this.onDurationUpdated,
// //   });
// //
// //   @override
// //   Widget build(BuildContext context) {
// //     final pct = cls.totalStudents > 0
...
// //                       child: Text(
// //                         '${cls.number.toString().padLeft(2, '0')}',
// //                         style: const TextStyle(
// //                           fontSize: 12,
// //                           fontWeight: FontWeight.w600,
// //                           color: Color(0xFF4A47B0),
// //                         ),
// //                       ),
// //                     ),
// //                     const SizedBox(width: 10),
...
// //                     _AttendanceBadge(taken: cls.attendanceTaken),
// //                   ],
// //                 ),
// //                 const SizedBox(height: 8),
// //                 Wrap(
...
// //                       label: '${cls.totalStudents} students',
// //                     ),
...
// //                           value: cls.attendanceTaken ? pct / 100 : 0,
...
// //             child: Row(
// //               children: [
// //                 // Attendance button — changes label if already taken
// //                 Expanded(
// //                   child: _ActionButton(
...
// //                     bgColor: cls.attendanceTaken
// //                         ? const Color(0xFFF5F4FF)
// //                         : const Color(0xFF4A47B0),
// //                     textColor: cls.attendanceTaken
// //                         ? const Color(0xFF4A47B0)
// //                         : Colors.white,
// //                     borderColor: const Color(0xFF4A47B0),
...
// //       builder: (_) => AttendanceSheet(cls: cls, onSaved: onAttendanceSaved),
// //     );
// //   }
// //
...
// //       backgroundColor: Colors.transparent,
// //       builder: (_) =>
// //           UpdateDurationSheet(cls: cls, onUpdated: onDurationUpdated),
// //     );
// //   }
// // }
// class _ClassCard extends StatelessWidget {
...
//                     ),
//                     const SizedBox(width: 6),
//                     // ✅ status badge using classStatus from ClassItem
...
//                     _MetaChip(
//                       icon: Icons.calendar_today_outlined,
//                       label: cls.date.isNotEmpty ? cls.date : '—',
//                     ),
//                     _MetaChip(
//                       icon: Icons.access_time_outlined,
//                       // ✅ format from timeStart / timeEnd
//                       label:
...
//                     icon: Icons.how_to_reg_outlined,
//                     bgColor: const Color(0xFF4A47B0),
...
//                     borderColor: const Color(0xFFEEEEEE),
//                     onTap: () {
//                       if (cls.recordedVideo != null &&
//                           cls.recordedVideo!.isNotEmpty) {
//                         Navigator.push(
//                           context,
//                           MaterialPageRoute(
//                             builder: (_) => RecordedVideoWithDoubt(
//                               title: cls.title,
//                               videoUrl: cls.recordedVideo as String,
//                               classId: cls.id,
//                               type: 'course',
//                             ),
//                           ),
...
//   }
//
//   // ✅ format ISO datetime → time only e.g. "09:00 AM"
...
// }
//
// // ✅ replaced _AttendanceBadge with _StatusBadge using ClassItem.classStatus
...
//   final bool taken;
//   const _AttendanceBadge({required this.taken});
//
//   @override
//   Widget build(BuildContext context) {
//     return Container(
//       padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
//       decoration: BoxDecoration(
//         color: taken ? const Color(0xFFE8F5E9) : const Color(0xFFFFF3E0),
//         borderRadius: BorderRadius.circular(20),
//       ),
//       child: Text(
//         taken ? 'Attendance done' : 'Attendance pending',
//         style: TextStyle(
//           fontSize: 10,
//           fontWeight: FontWeight.w500,
//           color: taken ? const Color(0xFF2E7D32) : const Color(0xFFB85C00),
//         ),
//       ),
//     );
//   }
