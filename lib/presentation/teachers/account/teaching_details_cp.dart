...
class TeachingDetailsCp extends ConsumerStatefulWidget {
  const TeachingDetailsCp({super.key});

  @override
  ConsumerState<TeachingDetailsCp> createState() => _TeachingDetailsCpState();
}

class _TeachingDetailsCpState extends ConsumerState<TeachingDetailsCp> {
